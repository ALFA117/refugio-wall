    ...
    <main className="relative mx-auto flex min-h-dvh w-full max-w-lg flex-col items-center justify-center px-5 text-center">
      <div
        ...
        style={{
          width: 64,
          height: 64,
          background: "radial-gradient(circle at 35% 30%, rgba(255,100,80,0.4), rgba(255,60,40,0.15) 72%)",
          border: "1px solid var(--line)",
        }}
      />
      <h1 className="font-serif-display mt-6 text-3xl font-semibold tracking-tight">The fire flickered.</h1>
      <p className="mt-2 max-w-xs text-[14px]" style={{ color: "var(--ash)" }}>
        Something went wrong loading this page. It&apos;s usually temporary.
      </p>
      <button
        onClick={reset}
